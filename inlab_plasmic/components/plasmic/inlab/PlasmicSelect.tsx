...
import Label from "../../Label"; // plasmic-import: pd0EFGF9oj3X/component
...
import Description from "../../Description"; // plasmic-import: aHIvCkjDnj3W/component
import MenuPopover from "../../MenuPopover"; // plasmic-import: KQwHBwK6WnMZ/component
import MenuItem from "../../MenuItem"; // plasmic-import: 8n8tp8Zp9D88/component
import MenuSection from "../../MenuSection"; // plasmic-import: T3nOCWnfjpj8/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: Ll-T-rC5P8LC/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection___4Koc)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
