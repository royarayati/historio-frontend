...
export type PlasmicMyprofile__OverridesType = {
  ...
  firstName2?: p.Flex<"div">;
  نام?: p.Flex<typeof TextInput>;
  lastName?: p.Flex<"div">;
  lastName2?: p.Flex<"div">;
  نامخانواد?: p.Flex<typeof TextInput>;
  email?: p.Flex<"div">;
  email2?: p.Flex<"div">;
  امل?: p.Flex<typeof TextInput>;
  عسروفال?: p.Flex<"div">;
  email4?: p.Flex<"div">;
          ...
          <div className={classNames(projectcss.all, sty.freeBox__wr82L)}>
            ...
            >
              ...
              {(() => {
                const child$Props = {
                  ...
                  onChange: (...eventArgs) => {
                    p.generateStateOnChangeProp($state, ["نام", "value"])(
                  ...
                  value:
                    p.generateStateValueProp($state, ["نام", "value"]) ?? ""
                };
            ...
            >
              ...
              {(() => {
                const child$Props = {
                  ...
                  onChange: (...eventArgs) => {
                    p.generateStateOnChangeProp($state, ["نامخانواد", "value"])(
                      (e => e.target?.value).apply(null, eventArgs)
                    );
                  },
                  placeholder: (() => {
                  ...
                  type: "text",
                  value:
                    p.generateStateValueProp($state, ["نامخانواد", "value"]) ??
                    ""
                };
            ...
            >
              ...
              {(() => {
                const child$Props = {
                  ...
                  onChange: (...eventArgs) => {
                    p.generateStateOnChangeProp($state, ["امل", "value"])(
                      (e => e.target?.value).apply(null, eventArgs)
                    );
                  },
                  placeholder: (() => {
                  ...
                  type: "email",
                  value:
                    p.generateStateValueProp($state, ["امل", "value"]) ?? ""
                };
            ...
            >
              ...
              <UploadWrapper
                ...
                files={p.generateStateValueProp($state, ["عسروفال2", "files"])}
                listType={"picture"}
                maxCount={1}
