...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: 8n8tp8Zp9D88/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__r913H)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__swfNk)}>
            <div
              className={classNames(
                projectcss.all,
