...
export type BookmarkSquareSvgrepoComsvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function BookmarkSquareSvgrepoComsvgIcon(
  props: BookmarkSquareSvgrepoComsvgIconProps
) {
...
export default BookmarkSquareSvgrepoComsvgIcon;
/* prettier-ignore-end */
