...
export type BookmarkSvgrepoComsvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function BookmarkSvgrepoComsvgIcon(
  props: BookmarkSvgrepoComsvgIconProps
) {
  ...
  return (
    ...
    >
      ...
      <path
        d={"M9 5.25a.75.75 0 000 1.5h6a.75.75 0 000-1.5H9z"}
        fill={"currentColor"}
      ></path>
...
export default BookmarkSvgrepoComsvgIcon;
/* prettier-ignore-end */
