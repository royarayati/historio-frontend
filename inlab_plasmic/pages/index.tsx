    ...
    <div style={{ width: "100%", padding: "100px", alignContent: "center" }}>
      <header>
        ...
        <h4>
          ...
          <h3>Your pages:</h3>
          <ul>
            <li><Link href="/laboratory_data/[slug]/[slug2]">LaboratoryData - /laboratory_data/[slug]/[slug2]</Link></li>
<li><Link href="/imaging_report/[slug]/[slug2]">ImagingReport1 - /imaging_report/[slug]/[slug2]</Link></li>
<li><Link href="/patient_profile/[slug]/[slug2]">PatientProfile - /patient_profile/[slug]/[slug2]</Link></li>
<li><Link href="/imaging_report-2/[radiologyreport]">ImagingReport2 - /imaging_report-2/[radiologyreport]</Link></li>
<li><Link href="/[UserToken]">SearchPatient - /[UserToken]</Link></li>
