...
import BookmarkIcon from "../../BookmarkIcon"; // plasmic-import: h-RZSpQ1GOWv/component
...
import sty from "./PlasmicImagingReportList.module.css"; // plasmic-import: nrqSmnRKw92g/css
...
import LastTrackButtonSvgrepoComSvgIcon from "./icons/PlasmicIcon__LastTrackButtonSvgrepoComSvg"; // plasmic-import: Kq4dfqgu3UnG/icon
    ...
    <React.Fragment>
      ...
      >
        ...
        <AntdModal
          ...
          title={
            <div className={classNames(projectcss.all, sty.freeBox___4AtdB)}>
              {false ? (
                <div
              ...
              <div className={classNames(projectcss.all, sty.freeBox__bhZiq)}>
                <CopyIconSvgIcon
          ...
          wrapClassName={classNames({ [sty["pcls_JI16iDLQTeFN"]]: true })}
        >
          <div className={classNames(projectcss.all, sty.freeBox__gnhL5)}>
            <div
              ...
              >
                ...
                <TextInput
                  ...
                  endIcon={
                    $state.value !== "" ? (
                      <Icons8CloseSvgIcon
                        className={classNames(projectcss.all, sty.svg__w0PkS)}
                        onClick={async event => {
                          const $steps = {};
                  ...
                  startIcon={
                    <EvaEdit2OutlineIcon
                      className={classNames(projectcss.all, sty.svg__dXKpF)}
                      role={"img"}
                    />
                  }
                  value={
        ...
        <AntdModal
          ...
          trigger={null}
          width={"85%"}
          wrapClassName={classNames({ [sty["pcls_yARaJGc72M0X"]]: true })}
        >
          <div className={classNames(projectcss.all, sty.freeBox__f3Nsr)}>
            <AntdRadioGroup
            ...
            >
              <AntdRadio
                className={classNames("__wab_instance", sty.radio__ydl4H)}
                value={"op1"}
              >
                <div
                  className={classNames(
              ...
              <AntdRadio
                className={classNames("__wab_instance", sty.radio__wu6QC)}
                value={"op2"}
              >
                <div
                  className={classNames(
            ...
            <TextInput
              ...
              endIcon={
                $state.value !== "" ? (
                  <Icons8CloseSvgIcon
                    className={classNames(projectcss.all, sty.svg__rc2K)}
                    onClick={async event => {
                      const $steps = {};
              ...
              startIcon={
                <EvaEdit2OutlineIcon
                  className={classNames(projectcss.all, sty.svg__xdFxI)}
                  role={"img"}
                />
              }
              value={
            ...
            {false ? (
              <TextInput
                ...
                endIcon={
                  $state.value !== "" ? (
                    <Icons8CloseSvgIcon
                      className={classNames(projectcss.all, sty.svg__r7Bma)}
                      onClick={async event => {
                        const $steps = {};
            ...
            {(() => {
              ...
              >
                <AntdButton
                  className={classNames("__wab_instance", sty.button__sWzeE)}
                >
                  <div
                    className={classNames(
                      projectcss.all,
        ...
        <AntdModal
          ...
          trigger={null}
          width={"85%"}
          wrapClassName={classNames({ [sty["pcls_W8QcaPlmyJro"]]: true })}
        >
          <div
            className={classNames(projectcss.all, sty.freeBox__lH3P, {
              [sty.freeBoxshowReportSummary__lH3P3Iing]: hasVariant(
                $state,
                "showReportSummary",
                "showReportSummary"
              )
          ...
          >
            ...
            <div
              className={classNames(projectcss.all, sty.freeBox__suzQx, {
                [sty.freeBoxshowReportSummary__suzQx3Iing]: hasVariant(
                  $state,
                  "showReportSummary",
                  "showReportSummary"
                )
        ...
        <AntdModal
          ...
          trigger={null}
          width={"85%"}
          wrapClassName={classNames({ [sty["pcls_OwZvpax456on"]]: true })}
        >
          <div className={classNames(projectcss.all, sty.freeBox__gDOp)}>
            <div
              className={classNames(
                projectcss.all,
                projectcss.__wab_text,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__dm4Bi)}>
              <Button
        ...
        {$state.selectedTab === "ParaclinicReports" ? (
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__syYjR)}>
              <ApiFetcherComponentPlus
                                            ...
                                            {$ctx => (
                                              <div
                                                className={classNames(
                                                  ...
                                                  sty.freeBox___2Yn4N,
                                                  {
                                                    [sty.freeBoxshowReportSummary___2Yn4N3Iing]:
                                                      hasVariant(
                                                        $state,
                                                        "showReportSummary",
                                                        "showReportSummary"
                                              ...
                                              >
                                                <div
                                                  className={classNames(
                                                    ...
                                                    sty.text__lypb1,
                                                    {
                                                      [sty.textshowReportSummary__lypb13Iing]:
                                                        hasVariant(
                                                          $state,
                                                          "showReportSummary",
                                                          "showReportSummary"
                                                ...
                                                {(
                                                  ...
                                                  <div
                                                    className={classNames(
                                                      ...
                                                      sty.text__pakVg,
                                                      {
                                                        [sty.textshowReportSummary__pakVg3Iing]:
                                                          hasVariant(
                                                            $state,
                                                            "showReportSummary",
                                                            "showReportSummary"
                                                        ...
                                                        return (
                                                          <div
                                                            className={classNames(
                                                              ...
                                                              sty.freeBox__a4R2V,
                                                              {
                                                                [sty.freeBoxshowReportSummary__a4R2V3Iing]:
                                                                  hasVariant(
                                                                    $state,
                                                                    "showReportSummary",
                                                                    "showReportSummary"
                                                          ...
                                                          >
                                                            <div
                                                              className={classNames(
                                                                ...
                                                                sty.freeBox___76TRx,
                                                                {
                                                                  [sty.freeBoxshowReportSummary___76TRx3Iing]:
                                                                    hasVariant(
                                                                      $state,
                                                                      "showReportSummary",
                                                                      "showReportSummary"
                                                            ...
                                                            >
                                                              ...
                                                              <div
                                                                className={classNames(
                                                                  ...
                                                                  sty.text__l5Cn1,
                                                                  {
                                                                    [sty.textshowReportSummary__l5Cn13Iing]:
                                                                      hasVariant(
                                                                        $state,
                                                                        "showReportSummary",
                                                                        "showReportSummary"
