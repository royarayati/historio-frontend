...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 7E4Snh8PZrgu/css
    ...
    <button
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootshape_rounded_size4_compact]:
          ...
          [sty.rootsize4_compact_shape_round]:
    ...
    >
      <div
        className={classNames(
          ...
          sty.text__xlEkx,
          {
            [sty.textcolor_clear__xlEkxt8PJz]: hasVariant(
              $state,
              "color",
              "clear"
            ),
            [sty.texthoverSelected__xlEkxrti7N]: hasVariant(
              $state,
              "hoverSelected",
              "hoverSelected"
            ),
            [sty.textselected__xlEkxq4VHk]: hasVariant(
              $state,
              "selected",
              "selected"
            )
      ...
      <div
        className={classNames(
          ...
          sty.text__mTt,
          {
            [sty.textcolor_clear__mTtT8PJz]: hasVariant(
              $state,
              "color",
              "clear"
            ),
            [sty.texthoverSelected__mTtRti7N]: hasVariant(
              $state,
              "hoverSelected",
              "hoverSelected"
            ),
            [sty.textselected__mTtQ4VHk]: hasVariant(
              $state,
              "selected",
              "selected"
            )
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.contentContainer, {
          ...
          [sty.contentContainerselected_color_purple]:
            hasVariant($state, "color", "purple") &&
            hasVariant($state, "selected", "selected"),
      ...
      >
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrendeselected_selected]:
              hasVariant($state, "selected", "selected") &&
              hasVariant($state, "deselected", "deselected"),
            ...
            [sty.slotTargetChildrenselected_color_purple]:
              hasVariant($state, "color", "purple") &&
              hasVariant($state, "selected", "selected"),
      ...
      {false ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__gCrFn)}
                role={"img"}
              />
            ),
      ...
      {false ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__p6THf)}
                role={"img"}
              />
            ),
