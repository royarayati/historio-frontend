...
import sty from "./PlasmicBullet.module.css"; // plasmic-import: yqxQTqUcR3_p/css

import IndicatorIcon from "./icons/PlasmicIcon__Indicator"; // plasmic-import: AmG__JNvJIWs/icon
