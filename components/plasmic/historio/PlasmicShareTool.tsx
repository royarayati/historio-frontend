...
import sty from "./PlasmicShareTool.module.css"; // plasmic-import: _oZbQztMxPh0/css

import ShareSvgrepoComSvgIcon from "./icons/PlasmicIcon__ShareSvgrepoComSvg"; // plasmic-import: LJO_Yj_xXdgY/icon
