...
import Label from "../../Label"; // plasmic-import: MmqzRnkzAliw/component
...
import Description from "../../Description"; // plasmic-import: _beZrqYURQd-/component
import MenuPopover from "../../MenuPopover"; // plasmic-import: zXxHKmG8tn-s/component
import MenuItem from "../../MenuItem"; // plasmic-import: z9RWs0wO3-6K/component
import MenuSection from "../../MenuSection"; // plasmic-import: _IO_V29nv-TV/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: NEnHRmoTPPoS/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__ydJm)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
