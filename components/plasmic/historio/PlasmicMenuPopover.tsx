...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: zXxHKmG8tn-s/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__jdVa)}
                    label={"Item 2"}
                    value={"item2"}
                  />
