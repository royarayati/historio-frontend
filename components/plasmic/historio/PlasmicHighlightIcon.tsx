...
import sty from "./PlasmicHighlightIcon.module.css"; // plasmic-import: i0HZSx2htseJ/css

import EmptyCircleSvgrepoComSvgIcon from "./icons/PlasmicIcon__EmptyCircleSvgrepoComSvg"; // plasmic-import: OtD4Ly7SbMQk/icon
import CheckCircleSvgrepoCom1SvgIcon from "./icons/PlasmicIcon__CheckCircleSvgrepoCom1Svg"; // plasmic-import: nZLmRlBWS1ka/icon
import LoaderSpinnerIcon from "./icons/PlasmicIcon__LoaderSpinner"; // plasmic-import: 6KShIgAISqiQ/icon
    ...
    <PlasmicIcon__
      ...
      className={classNames(
        ...
        sty.highlightIcon,
        {
          ...
          [sty.highlightIconloadingHighlighting_highlighting]:
            hasVariant($state, "highlighting", "highlighting") &&
            hasVariant($state, "loadingHighlighting", "loadingHighlighting")
        }
      )}
