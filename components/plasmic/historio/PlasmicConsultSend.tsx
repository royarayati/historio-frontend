...
import sty from "./PlasmicConsultSend.module.css"; // plasmic-import: 0sU2bIIokdcB/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <SwitchingTab
              className={classNames("__wab_instance", sty.switchingTab__mn1Wn)}
            >
              <PlasmicImg__
