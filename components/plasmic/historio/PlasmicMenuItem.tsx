...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: z9RWs0wO3-6K/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___75Ukf)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__gpvrv)}>
            <div
              className={classNames(
                projectcss.all,
