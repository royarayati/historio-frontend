...
import ShareTool from "../../ShareTool"; // plasmic-import: _oZbQztMxPh0/component
...
import sty from "./PlasmicUserSetting.module.css"; // plasmic-import: NxQYaHjzaWfx/css
...
import ProfileIcon from "./icons/PlasmicIcon__Profile"; // plasmic-import: J9MYkqdLTrBz/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: gXQ01zQH1U8L/icon
import Group1917Icon from "./icons/PlasmicIcon__Group1917"; // plasmic-import: 5LNfI2_xyPye/icon
import Signature6089035SvgIcon from "./icons/PlasmicIcon__Signature6089035Svg"; // plasmic-import: Db-ZzEz73IW0/icon
import HospitalReceptionSvgrepoComSvgIcon from "./icons/PlasmicIcon__HospitalReceptionSvgrepoComSvg"; // plasmic-import: FNgXc1y9nkWH/icon
        ...
        >
          ...
          >
            ...
            >
              ...
              <ProfileIcon
                className={classNames(projectcss.all, sty.svg__sXaOr)}
                role={"img"}
              />
            </div>
            <div
            ...
            <Button
              ...
              startIcon={
                <CheckSvgIcon
                  className={classNames(projectcss.all, sty.svg__rzWiq)}
                  role={"img"}
                />
              }
            >
              <div
                className={classNames(
                  ...
                  sty.text__xclUo,
                  {
                    [sty.textdisabledLogoutButton__xclUoX3OjF]: hasVariant(
                      $state,
                      "disabledLogoutButton",
                      "disabledLogoutButton"
                    )
          ...
          <AntdModal
            ...
            trigger={null}
            wrapClassName={classNames({ [sty["pcls_SPkKI-B5ZPy8"]]: true })}
          >
            <div
              ...
              >
                <TextInput
                  ...
                  endIcon={
                    $state.value !== "" ? (
                      <Icons8CloseSvgIcon
                        className={classNames(projectcss.all, sty.svg__mxb35)}
                        onClick={async event => {
                          const $steps = {};
              ...
              >
                <TextInput
                  ...
                  endIcon={
                    $state.value !== "" ? (
                      <Icons8CloseSvgIcon
                        className={classNames(projectcss.all, sty.svg__uVMV)}
                        onClick={async event => {
                          const $steps = {};
          ...
          {(() => {
            ...
            <AntdModal
              ...
              trigger={null}
              wrapClassName={classNames({ [sty["pcls_trPHRokG_IXm"]]: true })}
            >
              <div
              ...
              >
                ...
                <PlasmicImg__
                  alt={""}
                  className={classNames(sty.img__dFm4C)}
                  displayHeight={"auto"}
                  ...
                  loading={"lazy"}
                  src={{
                    src: "/new_inlab/plasmic/historio/images/عکسمهروامضاپوشیدهشدهJpg2.jpg",
                    fullWidth: 2100,
                    fullHeight: 940,
          ...
          >
            ...
            >
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__jGXn)}
                displayHeight={"25px"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img___3X73D)}
                displayHeight={"25px"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__o8O8)}
                displayHeight={"25px"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
              ...
              <PlasmicImg__
                alt={""}
                className={classNames(sty.img__fe7Cw)}
                displayHeight={"25px"}
                displayMaxHeight={"none"}
                displayMaxWidth={"100%"}
                displayMinHeight={"0"}
