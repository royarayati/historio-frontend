...
import sty from "./PlasmicConsultSendDraft.module.css"; // plasmic-import: N3lzJ_rD8tf2/css
    ...
    <React.Fragment>
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            <SwitchingTab
              className={classNames("__wab_instance", sty.switchingTab___6QrZv)}
            >
              <PlasmicImg__
