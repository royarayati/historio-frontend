...
import Button2 from "../../Button2"; // plasmic-import: XtocEoGBwLo3/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: qij1nVQZfRCY/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_k1xpARJO-ZNf"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox__c98Y1)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__jdOfl)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__oNe6K)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button2
                  className={classNames("__wab_instance", sty.button2__iukp)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
