...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: KQwHBwK6WnMZ/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__jGgS)}
                    label={"Item 2"}
                    value={"item2"}
                  />
